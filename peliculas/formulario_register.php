...
<form action="exito_insert.php" method="post" name="register">
    <div class="container">
        <h1>Registrate</h1>
        ...
        <hr>
        <p>Vuelve a la pagina <a href="main.php">IMDBM</a>.</p>

        <button type="submit" class="registerbtn" name="registrar">Register</button>
    </div>

    <div class="container signin">
        <p>Already have an account? <a href="formulario_loggin.php">Login</a>.</p>
    </div>
</form>
